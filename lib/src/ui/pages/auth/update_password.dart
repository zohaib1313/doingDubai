...
class _UpdatePasswordScreenState extends State<UpdatePasswordScreen> {
  ...
  updateProfile() async {
    ...
    try {
      ...
      var response = await _dio.post(path: AppUrl.updateProfile, data: formData);
      ...
      if (responseStatusCode == StatusCode.OK) {
        if (responseData['status']) {
          ...
          warningDialog(context, "", responseData['message'], closeOnBackPress: true, neutralButtonText: "OK");
        }
      } else {
