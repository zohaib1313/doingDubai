...
class AllClubsPage extends StatefulWidget {
  const AllClubsPage({Key? key}) : super(key: key);
                          ...
                          await AppNavigation().push(
                              ...
                              MakeInqury(
                                customModel: CustomInquiryModel(
                                  id: model.id,
                                  imageUrl: AppUrl.clubPicBaseUrl +
                                      (model.imageUrl ?? ''),
                                  key: 'club',
                                  name: model.club,
                                  ...
                                  children: [
                                    ClipRRect(
                                        ...
                                        fit: BoxFit.cover,
                                            ...
                                            Image.network(
                                          'http://dubai.applypressure.co.uk/images/clubpics/${item.imageUrl}',
                                          width: 120,
                                          height: 150,
                                          fit: BoxFit.cover,
                                        )),
