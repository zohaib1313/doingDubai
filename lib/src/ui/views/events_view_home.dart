...
class EventsViewHome extends StatefulWidget {
  EventsViewHome({Key? key}) : super(key: key);

  @override
  _EventsViewHomeState createState() => _EventsViewHomeState();
}

class _EventsViewHomeState extends State<EventsViewHome> {
  late AppDio _dio;
  ...
  Widget getInfoCardItem(EventsModel event) {
    return GestureDetector(
      onTap: () async {
        EventsMainModel? model = await NetworkCalls.getOneEvent(
              ...
              child: Row(
                ...
                children: [
                  ClipRRect(
                    ...
                    child: Image.network(
                      'http://dubai.applypressure.co.uk/images/eventpics/${event.imageUrl}',
                      width: 120,
                      height: 150,
                      fit: BoxFit.cover,
                    ),
