...
class AllTransporters extends StatefulWidget {
  const AllTransporters({Key? key}) : super(key: key);

  @override
  _AllTransportersState createState() => _AllTransportersState();
}
                          ...
                          child: Row(
                            ...
                            children: [
                              ClipRRect(
                                  ...
                                  Image.network(
                                    'http://dubai.applypressure.co.uk/images/transportpics/${item.imageUrl}',
                                    width: 120,
                                    height: 150,
                                    fit: BoxFit.cover,
                                  )),
